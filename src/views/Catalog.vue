    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center py-12">
        ...
        <p class="text-stone-500 max-w-2xl mx-auto">
          Explore and discover a selection of beautiful bouquets hand-curated with all our heart.
        </p>
      </div>
      ...
      >
        <div
          ...
          :key="product.id"
          class="bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-lg transition-shadow duration-300 flex flex-col h-full"
        >
          <!-- Image Section -->
          <div
            class="relative aspect-square overflow-hidden bg-stone-100 group cursor-pointer"
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <p class="text-sm text-stone-500 mb-6 leading-relaxed line-clamp-2">
              {{
                product.description ||
                'Stunning handcrafted bouquet suitable for beautiful moments.'
              }}
            </p>
      ...
      <div v-else class="py-20 text-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-16 w-16 mx-auto text-rose-200 mb-4"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <button
          @click="
            ...
            activeCategory = 'All'
          "
          class="mt-6 font-bold text-rose-600 hover:text-rose-800 transition"
        >
          Reset Search
        </button>
      </div>
      ...
      >
        ...
        <div class="w-full md:w-1/2 p-8 md:p-10 flex flex-col overflow-y-auto">
          ...
          <div class="mt-auto pt-6 border-t border-rose-50 flex gap-4">
            <button
              class="flex-1 bg-[#8B3A3A] hover:bg-[#682a2a] text-white py-4 rounded-xl font-bold transition-all shadow-lg flex justify-center items-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
